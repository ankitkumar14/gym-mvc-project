...
<div class="container">
	<form:form method="post" modelAttribute="slot" action="addslot" class="form-inline">
	<div class="form-group">
			...
			<br>
				<form:input path="slot_no" type="integer" class="form-control" placeholder="slot_no" value="0"/>
				<!-- bind to user.name-->
